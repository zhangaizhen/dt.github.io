					...
					<div class="col-lg-12">
						<div class="header-top-item">
							<div class="header-info">
								<ul>
									<li><a href="#"><i class="flaticon-email-2"></i> needhelp@163.com</a></li>
									<li><a href="#"><i class="flaticon-call"></i> 92 666 888 0000</a></li>
									<li><a href="#"><i class="flaticon-pin"></i> 66 Broklyn New Street, CAN</a></li>
								</ul>
							</div>
							<div class="social">
								<ul>
						...
						<div class="main-header-item">
							<div class="main-header-menus  d-flex justify-content-between align-items-center">
								<div class="header-logo">
									<a href="/"><img style="width: 60px;height:60px" src="/assets/images/logo-3.png" alt=""></a>
								</div>
